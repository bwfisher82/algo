...
from main import find_closest_value_in_bst, Node, binary_insert


class TestBSTClosestValue:
    @classmethod
    def _generate_test_bst(cls, data: dict[str, Any]) -> (Node, int):
        ...
        return bst_root, target

    @classmethod
    def _get_data_test_case_1(cls) -> (Node, int):
        data = {
          "tree": {
            "nodes": [
        ...
        return cls._generate_test_bst(data)

    @classmethod
    def _get_data_test_case_2(cls) -> (Node, int):
        data = {
          "tree": {
            "nodes": [
    ...
    @classmethod
    def _get_data_test_case_3(cls) -> (Node, int):
        data = {
          "tree": {
            "nodes": [
              {"id": "100", "left": "5", "right": "502", "value": 100},
    ...
    @classmethod
    def _get_data_test_case_4(cls) -> (Node, int):
        data = {
          "tree": {
            "nodes": [
              {"id": "100", "left": "5", "right": "502", "value": 100},
    ...
    @classmethod
    def _get_data_test_case_5(cls) -> (Node, int):
        data = {
          "tree": {
            "nodes": [
              {"id": "100", "left": "5", "right": "502", "value": 100},
    ...
    @classmethod
    def _get_data_test_case_6(cls) -> (Node, int):
        data = {
          "tree": {
            "nodes": [
              {"id": "100", "left": "5", "right": "502", "value": 100},
    ...
    @classmethod
    def _get_data_test_case_7(cls) -> (Node, int):
        data = {
          "tree": {
            "nodes": [
              {"id": "100", "left": "5", "right": "502", "value": 100},
    ...
    @classmethod
    def _get_data_test_case_8(cls) -> (Node, int):
        data = {
          "tree": {
            "nodes": [
              {"id": "100", "left": "5", "right": "502", "value": 100},
    ...
    @classmethod
    def _get_data_test_case_9(cls) -> (Node, int):
        data = {
          "tree": {
            "nodes": [
              {"id": "100", "left": "5", "right": "502", "value": 100},
    ...
    @classmethod
    def _get_data_test_case_10(cls) -> (Node, int):
        data = {
          "tree": {
            "nodes": [
              {"id": "100", "left": "5", "right": "502", "value": 100},
    ...
    @classmethod
    def _get_data_test_case_11(cls) -> (Node, int):
        data = {
          "tree": {
            "nodes": [
              {"id": "100", "left": "5", "right": "502", "value": 100},
    ...
    @classmethod
    def _get_data_test_case_12(cls) -> (Node, int):
        data = {
          "tree": {
            "nodes": [
              {"id": "100", "left": "5", "right": "502", "value": 100},
