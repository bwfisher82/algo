...
from main import find_branch_sums


class TestBranchSums:
    @classmethod
    ...
    def test_case_1(self):
        (bst) = self.__class__._get_data_test_case_1()
        assert find_branch_sums(bst) == 13

    def test_case_2(self):
        (bst) = self.__class__._get_data_test_case_2()
        assert find_branch_sums(bst) == 100

    def test_case_3(self):
        (bst) = self.__class__._get_data_test_case_3()
        assert find_branch_sums(bst) == 208

    def test_case_4(self):
        (bst) = self.__class__._get_data_test_case_4()
        assert find_branch_sums(bst) == 4500

    def test_case_5(self):
        (bst) = self.__class__._get_data_test_case_5()
        assert find_branch_sums(bst) == 4500

    def test_case_6(self):
        (bst) = self.__class__._get_data_test_case_6()
        assert find_branch_sums(bst) == -51

    def test_case_7(self):
        (bst) = self.__class__._get_data_test_case_7()
        assert find_branch_sums(bst) == 1001

    def test_case_8(self):
        (bst) = self.__class__._get_data_test_case_8()
        assert find_branch_sums(bst) == 5

    def test_case_9(self):
        (bst) = self.__class__._get_data_test_case_9()
        assert find_branch_sums(bst) == 55_000

    def test_case_10(self):
        (bst) = self.__class__._get_data_test_case_10()
        assert find_branch_sums(bst) == 1

    def test_case_11(self):
        (bst) = self.__class__._get_data_test_case_11()
        assert find_branch_sums(bst) == 55_000

    def test_case_12(self):
        (bst) = self.__class__._get_data_test_case_12()
        assert find_branch_sums(bst) == 4500
